...
# relay_path = "lightcode/models/llama_2_7b_decoder_graph.json" # 10

# relay_path = "lightcode/models/len_comparison/gpt2_decoder_graph_5.json"
# relay_path = "lightcode/models/len_comparison/gpt2_decoder_graph_6.json"
# relay_path = "lightcode/models/len_comparison/gpt2_prefill_graph_5.json"
# relay_path = "lightcode/models/len_comparison/gpt2_prefill_graph_6.json"


# relay_path = "lightcode/models/gpt2_graph.json" # 5
# relay_path = "lightcode/models/gpt2_prefill_graph.json"
# relay_path = "lightcode/models/gpt2_decoder_graph.json" # 6
# relay_path = "lightcode/models/Llama-2-7b-hf_graph.json" # 6
# relay_path = "lightcode/models/opt0_Llama-2-7b-hf_graph.json" # 6
# relay_path = "lightcode/models/llama_2_7b_decoder_graph.json" # 11
